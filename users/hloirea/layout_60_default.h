...
#define __BL_4__ KC_LGUI,KC_LALT,KC_LCTL,                    KC_SPC,                     KC_RCTL,KC_RALT,MO(_FL),MO(_ML)
...
#define __ML_4__ TO(_BL),TO(_NL),TO(_FL),                    _______,                    _______,_______,_______,_______
