...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(combos_lmod[0],   KC_LALT),
    COMBO(combos_lmod[1],   KC_LSFT),
    COMBO(combos_lmod[2],   KC_LGUI),
    COMBO(combos_lmod[3],   KC_LSFT),

    COMBO(combos_rmod[0],   KC_RALT),
    COMBO(combos_rmod[1],   KC_RSFT),
    COMBO(combos_rmod[2],   KC_RGUI),
    COMBO(combos_rmod[3],   KC_RSFT),
