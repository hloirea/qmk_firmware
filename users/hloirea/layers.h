...
TD(TD_RESET),     TD(TD_L_GAME),    CW_TOGG,          KC_CAPS,          XXXXXXX,          KC_PSCR,          KC_F7,            KC_F8,            KC_F9,            KC_F12,           \
...
KC_A,             KC_S,             KC_D,             KC_F,             KC_G,             KC_H,             KC_J,             KC_K,             KC_L,             KC_SCLN,          \
U_P_Z,            KC_X,             KC_C,             KC_V,             KC_B,             KC_N,             KC_M,             KC_COMM,          KC_DOT,           U_P_SLSH,         \
                                    KC_LCTL,          KC_SPC,           KC_TAB,           TD(TD_L_BASE),    KC_BSPC,          KC_ENT

#define HLOIREA_LAYER_MOUSE \
XXXXXXX,          XXXXXXX,          XXXXXXX,          KC_BTN4,          KC_BTN5,          KC_BTN4,          KC_BTN5,          XXXXXXX,          XXXXXXX,          XXXXXXX,          \
