...
XXXXXXX,          TD(TD_L_MOUSE),   TD(TD_L_SYM),     TD(TD_L_NAV),     TD(TD_L_FUN),     XXXXXXX,          KC_SCRL,          KC_F4,            KC_F5,            KC_F6,            KC_F11,           XXXXXXX,          \
...
XXXXXXX,          KC_LEFT,          KC_DOWN,          KC_RGHT,          KC_PGDN,          KC_VOLD,          XXXXXXX,          TD(TD_L_NAV),     TD(TD_L_FUN),     TD(TD_L_SYM),     TD(TD_L_MOUSE),   XXXXXXX,          \
...
XXXXXXX,          KC_MS_L,          KC_MS_D,          KC_MS_R,          TD(TD_L_MOUSE),   KC_WH_D,          XXXXXXX,          KC_ACL0,          KC_ACL1,          KC_ACL2,          XXXXXXX,          XXXXXXX,          \
