...
LSFT_T(KC_Z),         KC_X,                 KC_C,                 KC_V,                 KC_B,                 KC_N,                 KC_M,                 TD(TD_T_CUSTOM_1),    KC_DOT,               RSFT_T(KC_SLSH),   \
                                            LCTL_T(KC_ESC),       LT(L_LOWER, KC_SPC),  LALT_T(U_P1),         RGUI_T(KC_ENT),       LT(L_UPPER, KC_BSPC), LCTL_T(KC_TAB)
...
LSFT_T(KC_SLSH),      KC_PLUS,              KC_MINS,              KC_ASTR,              KC_PERC,              KC_0,                 KC_1,                 KC_2,                 KC_3,                 KC_BSLS,           \
...
C(A(KC_DEL)),         S(KC_DEL),            C(KC_INS),            S(KC_INS),            KC_MUTE,              KC_PAUS,              KC_F1,                KC_F2,                KC_F3,                RSFT_T(KC_F10),    \
                                            XXXXXXX,              XXXXXXX,              XXXXXXX,              KC_RALT,              KC_DEL,               KC_RCTL
