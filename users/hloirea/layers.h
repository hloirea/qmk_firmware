...
<<<<<<< HEAD
QK_GESC,      KC_Q,         KC_W,         KC_E,         KC_R,         KC_T,         KC_Y,         KC_U,         KC_I,         KC_O,         KC_P,         KC_RGUI,   \
...
QK_GESC,      KC_TILD,      KC_CIRC,      KC_PIPE,      KC_AMPR,      XXXXXXX,      KC_AT,        KC_P7,        KC_P8,        KC_P9,        KC_DLR,       KC_RGUI,   \
KC_UNDS,      KC_EXLM,      KC_LABK,      KC_PEQL,      KC_RABK,      XXXXXXX,      KC_HASH,      KC_P4,        KC_P5,        KC_P6,        KC_QUES,      KC_QUOT,   \
KC_LALT,      KC_PSLS,      KC_PPLS,      KC_PMNS,      KC_PAST,      KC_PERC,      KC_P0,        KC_P1,        KC_P2,        KC_P3,        KC_BSLS,      KC_RALT,   \
                                          KC_LCTL,      KC_SPC,       KC_LSFT,      XXXXXXX,      XXXXXXX,      XXXXXXX

#define HLOIREA_LAYER_LOWER \
KC_BTN1,      KC_HOME,      KC_UP,        KC_END,       KC_PGUP,      KC_VOLU,      KC_PSCR,      KC_F7,        KC_F8,        KC_F9,        KC_F12,       KC_APP,    \
KC_BTN2,      KC_LEFT,      KC_DOWN,      KC_RGHT,      KC_PGDN,      KC_VOLD,      KC_SCRL,      KC_F4,        KC_F5,        KC_F6,        KC_F11,       KC_F14,    \
KC_BTN3,      TD(TD_RESET), S(KC_DEL),    C(KC_INS),    S(KC_INS),    KC_MUTE,      KC_PAUS,      KC_F1,        KC_F2,        KC_F3,        KC_F10,       KC_F13,    \
