  ...
  /* _BL: Basic Layer */
	[_BL] =
      LAYOUT_60_ansi_split_bs_rshift(
         ...
         KC_LALT, MO(_FL), KC_LCTL,                   KC_SPC,                     KC_LCTL, KC_LGUI, MO(_FL), KC_RALT),
  /* _FL: Function key Layer */
	[_FL] =
      LAYOUT_60_ansi_split_bs_rshift(
         ...
         _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, KC_APP,  MO(_CL),
         _______, _______, _______,                   _______,                    _______, _______, _______, _______),
  /* _UL: Utility Layer */
	[_UL] =
      LAYOUT_60_ansi_split_bs_rshift(
         _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, KC_MPRV, KC_MNXT, KC_CALC,  xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
         xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, KC_NLCK, KC_P7,    KC_P8,   KC_P9,   KC_PSLS, KC_PAST, xxxxxxx, xxxxxxx,
